...
nFibonacci(n) debe retornar el enésimo número de la secuencia de Fibonacci,
 tomando al 0 y al 1, respectivamente, como primer y segundo elementos de la misma,
  y sabiendo que cualquier elemento que se agregue a esta secuencia será 
...
al terminar de resolver este problema pueden intentar definir funciones 
...
function nFactorial(n) {
  var sumaFactorial = 0;
  if (n === 1) { return 1; }
  else { sumaFactorial += (n * nFactorial(n - 1)) }
...
function nFibonacci(n) {
  ...
  if (n === 0) { return 0; }
  if (n === 1) { return 1; }
  else { suma = nFibonacci(n - 1) + nFibonacci(n - 2) }
  return suma;
}
